...
class Question():
    ...
    def question_posseg(self):
        jieba.load_userdict("./data/event_dict.txt")
        jieba.load_userdict("./data/time_dict.txt")
        jieba.load_userdict("./data/location_dict.txt")
        jieba.load_userdict("./data/figure_dict.txt")
